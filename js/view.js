...
const View = {
    ...
    init() {
        this.dom = {
            ...
            updateMaketaBtn: document.getElementById('updateMaketaBtn'),
            copyBtn: document.getElementById('copyBtn'),
            saveAsTxtBtn: document.getElementById('saveAsTxtBtn'), // PRIDANÝ RIADOK
            modalOverlay: document.getElementById('confirmation-modal-overlay'),
            modalText: document.getElementById('modal-text'),
            modalConfirmBtn: document.getElementById('modal-confirm-btn'),
            modalCancelBtn: document.getElementById('modal-cancel-btn'),
            researchOverlay: document.getElementById('research-overlay'),
            openResearchBtn: document.getElementById('openResearchBtn'),
            closeResearchBtn: document.getElementById('closeResearchBtn'),
            ...
            resetRhymesMainBtn: document.getElementById('resetRhymesMainBtn'),
